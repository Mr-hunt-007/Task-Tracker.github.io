...
import { Search, ListIcon, LayoutGrid, Moon, Sun, Bell, ChevronDown, Mic } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useTheme } from "next-themes"
import type { Filter, List, SortOption, ViewLayout } from "@/types"
...
export function Header({
  ...
  return (
    <header className="bg-white dark:bg-gray-800 shadow-sm z-10 flex-shrink-0 transition-colors duration-200">
      <div className="flex items-center justify-between px-6 py-3 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
            <button
              className={cn(
                "view-toggle p-1 rounded-md transition-colors",
                viewLayout === "list"
